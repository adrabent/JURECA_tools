...
rm -rfv ${INSTALLDIR}/LOFARStMan && mkdir -pv $INSTALLDIR/LOFARStMan/build

cd ${INSTALLDIR}/LOFARStMan && git clone https://github.com/lofar-astron/LOFARStMan.git src
cd $INSTALLDIR/LOFARStMan/build
cmake -DCMAKE_INSTALL_PREFIX:PATH=${INSTALLDIR}/LOFARStMan ../src
nake && make install

rm -rfv ${INSTALLDIR}/LOFARStMan/build && rm -rfv ${INSTALLDIR}/LOFARStMan/src
